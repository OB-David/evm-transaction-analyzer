...
def _generate_analysis(context_json: str) -> dict[str, str]:
    ...
    base_user_prompt = (
        ...
        "Keep the wording compact and high level. Prefer semantic roles such as current contract, callee, input buffer, "
        "output buffer, or temporary memory region instead of copying raw trace literals.\n"
